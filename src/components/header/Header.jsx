...
const Header = () => {
  ...
  return (
    <>
      <div className="eollie_tm_topbar">
        <div className={navbar ? "topbar_inner opened" : "topbar_inner"}>
          <div className="logo">
          <a href="#home">
              <img src="/img/logo/new/light.png" alt="partners brand" />
          </a>
          </div>
          {/* End logo */}
          <div className="menu">
            <Scrollspy
              ...
              items={["home", "about", "strengths", "portfolio", "testimonials", "contact"]}
      ...
      {/* End eollie_tm_topbar */}

      {/* Start eollie mobile menu */}
      <div className="eollie_tm_mobile_menu">
          ...
          <div className="container">
            ...
            <div className="dropdown_inner">
              <ul className="anchor_nav">
                ...
                <li>
                  <a href="#strengths" onClick={handleClick}>
                    Strengths
                  </a>
                </li>
                <li>
